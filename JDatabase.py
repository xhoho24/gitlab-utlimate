...
class JsonDatabase(object):
    ...
    def create_user(self,name):
        self.items[name] = {'private_token':'---', 'project':0, 'host': '---', 'isadmin': 0, 'zips': 9, 'proxy': '', 'tokenize': 0}

    def create_admin(self,name):
        self.items[name] = {'private_token':'---', 'project':0, 'host': '---', 'isadmin': 1, 'zips': 9, 'proxy': '', 'tokenize': 0}
